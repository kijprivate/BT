...
class CoinexPerpetualApi(object):
    ...
    #My API
    def collectDepthData(self, vp, limit, stockName):
        try:
    ...
    def collectKlineData(self, vp, typeInMinutes, stockName):
        #try:
        ...
        fileName = "klineData_" + vp.pair + "_" + str(typeInMinutes) + "min" + "_" + stockName + ".csv"
        with open(fileName, 'a', newline='') as csv_file:
            csv_writer = csv.writer(csv_file, delimiter=',')
            csv_writer.writerow(data)
